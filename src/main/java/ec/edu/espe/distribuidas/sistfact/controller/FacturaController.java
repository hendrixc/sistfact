...
import ec.edu.espe.distribuidas.sistfact.dto.FacturaDetalleRQ;
import ec.edu.espe.distribuidas.sistfact.dto.FacturaRQ;
...
import ec.edu.espe.distribuidas.sistfact.model.FacturaDetallePK;
import ec.edu.espe.distribuidas.sistfact.service.FacturaService;
import ec.edu.espe.distribuidas.sistfact.transform.FacturaRSTransform;
...
public class FacturaController {
    ...
    public ResponseEntity registrar(@RequestBody FacturaRQ facturaRQ) {
        try {
            ...
            factura.setCodigoCliente(facturaRQ.getCodigoCliente());
            ...
            for (FacturaDetalleRQ detalleRQ : facturaRQ.getDetalles()) {
                ...
                FacturaDetallePK pk = new FacturaDetallePK();
                pk.setCodigoProducto(detalleRQ.getCodigoProducto());
                detalle.setPk(pk);
